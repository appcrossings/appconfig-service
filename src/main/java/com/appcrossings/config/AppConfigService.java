...
public interface AppConfigService {
  ...
  Response getTextProperties(@QueryParam("repo") String repo,
      @NotNull @PathParam("path") String path, @QueryParam("t") Boolean traverse, UriInfo info);
  ...
  Response getJsonProperties(@QueryParam("repo") String repo,
      @NotNull @PathParam("path") String path,
      @DefaultValue("true") @QueryParam("t") Boolean traverse, UriInfo info);
  ...
  Response getYamlProperties(@QueryParam("repo") String repo,
      @NotNull @PathParam("path") String path,
      @DefaultValue("true") @QueryParam("t") Boolean traverse, UriInfo info);
